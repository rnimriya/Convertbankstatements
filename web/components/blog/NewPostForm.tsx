...
export function NewPostForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="space-y-1.5">
        <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300">Feature Image URL</label>
        <input
          type="url"
          value={featureImage}
          ...
          className={INPUT}
        />
        <p className="text-xs text-zinc-400 dark:text-zinc-500">Leave blank to auto-generate from slug.</p>
      </div>
