...
export function AuthForm({ mode }: { mode: Mode }) {
  ...
  if (success) {
    return (
      <div className="flex min-h-[calc(100vh-180px)] items-center justify-center bg-gradient-to-br from-slate-50 to-brand-50 dark:from-gray-800 dark:to-gray-700 px-4 py-12">
        <div className="flex flex-col items-center gap-3 rounded-2xl border border-emerald-200 dark:border-emerald-800 bg-white dark:bg-gray-700 p-10 shadow-lg text-center">
  ...
  return (
    <div className="flex min-h-[calc(100vh-180px)] items-center justify-center bg-gradient-to-br from-slate-50 to-brand-50 dark:from-gray-800 dark:to-gray-700 px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-slate-200 dark:border-gray-600 bg-white dark:bg-gray-700 p-8 shadow-xl shadow-slate-200/50 dark:shadow-black/30">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 dark:border-gray-500 bg-slate-50 dark:bg-gray-600 px-4 py-2.5 pr-11 text-sm text-slate-900 dark:text-gray-100 placeholder-slate-400 dark:placeholder-gray-500 outline-none transition focus:border-brand-500 focus:bg-white dark:focus:bg-gray-700 focus:ring-2 focus:ring-brand-100 dark:focus:ring-brand-900/50"
                />
                <button
                  type="button"
