      ...
      <div className="relative z-10 w-full px-6 lg:px-10 xl:px-16 pt-10 pb-12">
        ...
        <div className="text-center mb-6 max-w-4xl mx-auto">
          ...
          <p className="text-[0.95rem] text-zinc-500 dark:text-zinc-400 max-w-2xl mx-auto leading-relaxed">
            Upload any Wells Fargo, Cadence Bank, U.S. Bank, Mountain America Credit Union, or Kotak statement — get CSV, Excel, OFX for Tally, or Google Sheets in under 15 seconds. No manual typing.
          </p>
        </div>
