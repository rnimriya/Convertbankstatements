    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 px-4 py-10">
      <div className="mx-auto max-w-2xl">
        ...
        <p className="text-zinc-500 dark:text-zinc-400 text-sm mb-8">
          Share your link. When a friend signs up, you both get <span className="font-semibold text-zinc-700 dark:text-zinc-200">50 free pages</span> — no strings attached.
        </p>
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <div className="bg-white dark:bg-zinc-950 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-5">
            ...
            <p className="text-xs text-zinc-400 dark:text-zinc-500 mt-0.5">via referrals</p>
          </div>
          <div className="bg-white dark:bg-zinc-950 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-5">
            <div className="flex items-center gap-2 text-zinc-400 dark:text-zinc-500 text-xs font-semibold uppercase tracking-wide mb-2">
              <Users size={13} />
            ...
            <p className="text-xs text-zinc-400 dark:text-zinc-500 mt-0.5">free pages for both</p>
          </div>
        </div>

        {/* Link card */}
        <div className="bg-white dark:bg-zinc-950 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 mb-6">
          <p className="text-sm font-semibold text-zinc-700 dark:text-zinc-200 mb-3">Your referral link</p>
          <div className="flex items-center gap-2">
            <div className="flex-1 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl px-4 py-3 text-sm text-zinc-600 dark:text-zinc-300 font-mono truncate">
              {referralUrl}
            </div>
            <button
              onClick={copyLink}
