    ...
    <div className="space-y-3">
      {logs.map((log) => {
        ...
        return (
          <div
            key={log.id}
            className="flex items-center gap-4 rounded-2xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-surface px-5 py-4 shadow-sm hover:shadow-md dark:hover:shadow-black/20 transition-shadow"
          >
            ...
            <div className="min-w-0 flex-1">
              <p className="truncate text-sm font-semibold text-zinc-800 dark:text-gray-200">{log.fileName}</p>
