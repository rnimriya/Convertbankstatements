      ...
      <div className="space-y-4">
        ...
        {hasMultipleBanks && successCount > 1 && (
          <div className="bg-zinc-900 dark:bg-zinc-950/5 dark:bg-brand-400/5 border border-navy/20 dark:border-brand-400/20 rounded-2xl p-4 flex items-center justify-between gap-4">
            <div>
              <p className="text-sm font-semibold text-navy dark:text-violet-400">Multiple banks detected</p>
                ...
                <div className="flex gap-1.5 shrink-0">
                  {r.exportUrls.xlsx && (
                    <a href={r.exportUrls.xlsx} download={r.fileName.replace(".pdf", ".xlsx")}
                      className="px-2.5 py-1.5 rounded-lg bg-zinc-900 dark:bg-zinc-950/10 dark:bg-brand-400/10 text-navy dark:text-violet-400 text-xs font-semibold hover:bg-zinc-900 dark:bg-zinc-950/20 dark:hover:bg-brand-400/20 transition-colors">
                      .xlsx
                    </a>
                  )}
                  {r.exportUrls.csv && (
      ...
      <div
        ...
        className={cn(
          ...
          isDragActive
            ...
            : "border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/60 dark:bg-zinc-950/60 hover:border-zinc-900/40 dark:border-zinc-800 dark:hover:border-brand-400/40 hover:bg-zinc-900 dark:bg-zinc-950/[0.02]",
        ...
        {phase === "processing" ? (
          ...
          <>
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-zinc-400 dark:text-zinc-500">or <span className="font-semibold text-navy dark:text-violet-400 underline underline-offset-2">browse files</span></p>
