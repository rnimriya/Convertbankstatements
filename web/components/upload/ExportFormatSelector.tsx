            ...
            <button
              ...
              className={`relative flex items-center gap-2.5 rounded-xl border px-3 py-2.5 text-left text-xs font-medium transition-all duration-150 ${
                active
                  ...
                  : "border-slate-200 dark:border-gray-800 bg-white dark:bg-gray-800 text-slate-600 dark:text-gray-300 hover:border-slate-300 dark:hover:border-gray-600 hover:bg-slate-50 dark:hover:bg-gray-800 hover:text-slate-800 dark:hover:text-gray-100"
              }`}
            >
