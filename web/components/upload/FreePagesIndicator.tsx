...
export function FreePagesIndicator({ tier, pagesUsed, monthlyPageLimit }: Props) {
  if (tier === "PRO" || tier === "BUSINESS") {
    ...
    return (
      <div className="rounded-xl border border-slate-200 dark:border-gray-800 bg-white dark:bg-gray-800 p-4 shadow-sm">
        ...
        <div className="mt-2 h-2 w-full rounded-full bg-slate-100 dark:bg-gray-800">
          <div
  ...
  if (tier === "FREE") {
    ...
    return (
      ...
      >
        ...
        <div className="mt-3 h-2 w-full rounded-full bg-slate-100 dark:bg-gray-800">
          <div
