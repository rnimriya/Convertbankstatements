    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 flex flex-col items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-1">Upload your bank statement PDF below. Your document will be converted and shared securely.</p>
        </div>
          ...
          {phase ==="idle" && (
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-zinc-400 dark:text-zinc-500 mt-0.5">or click to browse</p>
              </div>
              <p className="text-xs text-zinc-300 dark:text-zinc-600">PDF only · Max 50 MB</p>
            ...
            <div className="p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-400 dark:text-zinc-500">{txCount} transactions · {bankName}</p>
                </div>
              </div>
              ...
              <button
                ...
                className="mt-4 w-full text-sm text-zinc-400 dark:text-zinc-500 hover:text-zinc-600 dark:text-zinc-400 dark:hover:text-gray-300 transition-colors text-center"
              >
                Upload another file
              </button>
            </div>
          ...
          {phase ==="error" && (
            <div className="p-8 flex flex-col items-center gap-4 text-center">
              ...
              <div>
                ...
                <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-1">{errorMsg}</p>
              </div>
              <button
