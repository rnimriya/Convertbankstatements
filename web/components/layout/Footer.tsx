...
const SOCIAL = [
  {
    label: "X (Twitter)",
    href: "https://x.com/bankstatements_in",
    icon: (
  ...
  {
    label: "Facebook",
    href: "https://facebook.com/bankstatementsindia",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/bankstatements.india",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/bankstatements-india",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
