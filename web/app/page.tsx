        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-20 items-center">
          ...
          <div>
            ...
            <p className="text-[1.05rem] text-slate-500 leading-relaxed mb-7 max-w-[420px]">
              Upload any Indian bank PDF. Get clean spreadsheets instantly — no manual typing, no subscriptions traps.
            </p>
  ...
  const tiers = [
    {
      ...
      features: ["8 pages / month", "All output formats", "All 30+ banks", "No account needed"],
      cta: "Start free",
      href: "/convert",
      featured: false,
    },
    {
      ...
      price: "₹49",
      period: "/ doc",
      desc: "No commitment, pay per use",
      features: ["Unlimited pages/doc", "All output formats", "All 30+ banks", "No subscription"],
      cta: "Convert now",
      href: "/convert",
      featured: false,
    },
