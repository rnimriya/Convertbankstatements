...
function Navbar() {
  return (
    <nav className="sticky top-0 z-50 border-b border-slate-100 dark:border-gray-800 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
        ...
        <div className="flex flex-col items-center gap-8 lg:flex-row lg:items-center lg:gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="mt-5 flex flex-wrap items-center justify-center gap-3 lg:justify-start">
              ...
              <Link
                href="/pricing"
                className="flex items-center gap-1.5 rounded-lg border border-slate-200 dark:border-gray-800 bg-white dark:bg-gray-800 px-5 py-2.5 text-sm font-medium text-slate-600 dark:text-gray-300 hover:bg-slate-50 dark:hover:bg-gray-800 transition-colors"
              >
          ...
          <div className="w-full max-w-sm shrink-0 lg:max-w-xs xl:max-w-sm">
            <div className="overflow-hidden rounded-2xl border border-slate-200 dark:border-gray-800 shadow-xl shadow-slate-200/50 dark:shadow-black/30">
              <div className="flex items-center gap-2 border-b border-slate-100 dark:border-gray-800 bg-slate-50 dark:bg-gray-800 px-3 py-2">
                <div className="flex gap-1">
                  <div className="h-2.5 w-2.5 rounded-full bg-red-400" />
                  <div className="h-2.5 w-2.5 rounded-full bg-amber-400" />
                  <div className="h-2.5 w-2.5 rounded-full bg-emerald-400" />
                </div>
                <div className="mx-auto flex items-center gap-1.5 rounded border border-slate-200 dark:border-gray-800LITE bg-white dark:bg-gray-800 px-2 py-0.5 text-[10px] text-slate-400 dark:text-gray-400">
...
function MockDashboard() {
  return (
    <div className="bg-slate-50 dark:bg-gray-900 p-3 space-y-2">
      <div className="rounded-lg border border-slate-200 dark:border-gray-800 bg-white dark:bg-gray-800 px-3 py-2">
        ...
        <div className="mt-1.5 h-1.5 w-full rounded-full bg-slate-100 dark:bg-gray-800">
      ...
      <div className="flex items-center gap-2 rounded-lg border border-slate-200 dark:border-gray-800 bg-white dark:bg-gray-800 px-3 py-2">
...
function BankLogos() {
  return (
    <section className="border-y border-slate-100 dark:border-gray-800 bg-slate-50 dark:bg-gray-900/50 py-10">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          {INDIAN_BANKS.map((bank) => (
            <span key={bank} className="rounded-full border border-slate-200 dark:border-gray-800 bg-white dark:bg-gray-800 px-3 py-1 text-xs font-semibold text-slate-600 dark:text-gray-300 shadow-sm">
              {bank}
            </span>
          ))}
...
function HowItWorks() {
  return (
    <section id="how-it-works" className="bg-slate-50 dark:bg-gray-900/50 px-6 py-24">
      ...
      <div className="mx-auto max-w-5xl text-center">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 text-left">
          {FEATURES.map(({ icon, bg, title, desc }) => (
            <div key={title} className="rounded-2xl border border-slate-200 dark:border-gray-800 bg-white dark:bg-gray-800 p-6 shadow-sm hover:shadow-md dark:hover:shadow-black/20 transition-shadow">
...
function PricingPreview() {
  return (
    <section className="bg-slate-50 dark:bg-gray-900/50 px-6 py-24">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {PRICING.map(({ label, price, sub, highlight }) => (
            <div key={label} className={`rounded-2xl border p-5 text-left ${highlight ? "border-brand-400 bg-brand-600 text-white" : "border-slate-200 dark:border-gray-800 bg-white dark:bg-gray-800"}`}>
    ...
    <section id="faq" className="bg-white dark:bg-gray-900 px-6 py-24">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-10 space-y-3">
          {FAQS.map(({ q, a }) => (
            <details key={q} className="group rounded-2xl border border-slate-200 dark:border-gray-800 bg-slate-50 dark:bg-gray-800 p-5">
